# Capstone Skill Notes: Refined Math Tutor

## Skill Path

```text
.agent/skills/math-tutor.skill.md
```

## What Changed from Week 4

The Week 4 Math Tutor skill already required intuition before formalism,
worked examples, practice problems, and connections. The capstone version is
more specific and stricter:

- it adds capstone-scale output requirements: 5 worked examples, 10 practice
  problems, common mistakes, and a study checklist;
- it adds explicit proof standards for hypotheses, norms, spaces, compactness,
  density, coercivity, and regularity;
- it adds computational illustration standards so Python cells must explain the
  math, print meaningful diagnostics, and connect numerical behavior to the
  theorem;
- it adds trigger keywords for Sobolev spaces and weak formulations, matching
  the capstone topic.
